												...
												<div class="signup_form">
													...
													<div>
														...
														font-style: italic;margin-bottom: 3px;margin-top: 0px;padding: 14px;line-height: 25px;border-radius: 4px;border: 1px solid #169E8F;color: #169E8F;margin-left: 0;width: 300px;background-color: transparent;" class="">
																<option selected value="saree">Grains</option>
																<option value="ornament">Flours</option>
																<option value="watch">Cleaning</option>
																<option value="tshirt">Condiments</option>
																<option value="hijab">Spices</option>
																<option value="perfume">Pulses</option>
																<option value="footwear">Nuts</option>
																<option value="toiletry">Oil</option>
															</select>
														</td>
													</div>
													<div>
