	...
	<div class="holecontainer" style=" padding-top: 20px; padding: 0 20%">
		<div class="container signupform_content ">
			<div>
				...
				<h2 style="padding-bottom: 20px;">Order Confirmation</h2>
							...
							<form action="" method="POST" class="registration">
								<div class="signup_form" style="    margin-top: 38px;">
									...
									<div>
										...
										font-style: italic; margin-bottom: 3px;margin-top: 0px;padding: 14px;line-height: 25px;border-radius: 4px;border: 4px solid #F7A200;color: #fff;margin-left: 0;width: 300px;background-color: transparent;" class="">';
