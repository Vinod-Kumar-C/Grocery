	...
	<div class="categolis">
		<table>
			<tr>
				...
				<th><a href="powders.php" style="text-decoration: none;color: #F7A200;padding: 4px 12px;background-color: #047BD5;border-radius: 12px;">Flours</a></th>
